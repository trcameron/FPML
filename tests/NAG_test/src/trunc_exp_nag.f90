!********************************************************************************
!   TRUNC_EXP_NAG: Compare FPML against NAG on the truncated exponential.
...
program trunc_exp_nag
    ...
    open(unit=1,file="data_files/trunc_exp_nag.dat")
