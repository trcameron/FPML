...
!************************************************
!	Module: initial_estimates contains the
!	paramters and subroutines associated with 
!	computing the initial estimates for the roots 
!	of an univariate polynomial. 
!************************************************
module initial_estimates
	use rand_poly
	implicit none
	real(kind=dp), parameter	:: zero=0.0D0, one=1.0D0, big_one=-1.0D30, pi2 = 6.283185307179586D0, sigma = 0.7D0
contains
